...
Bundle::Math::Calculus - A bundle to install various calculus related modules

=head1 SYNOPSIS

 perl -MCPAN -e 'install Bundle::Math::Calculus'
...
This is a bundle of calculus related modules.
